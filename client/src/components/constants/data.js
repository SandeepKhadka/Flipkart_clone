...
export const leftBannerImages = {
  topOffers: "'../../assets/images/topOffers.png'",
  topDeals: "'../../assets/images/topDeals.png'",
  new_styles: "'../../assets/images/new_styles.png'",
  new_styles_him: "'../../assets/images/new_styles_him.png'",
  deals: "'../../assets/images/deals.png'",
  best_fashion: "'../../assets/images/best_fashion.png'",
};

export const topOffers = "'../../assets/images/topOffers.png'";
export const topDeals = "'../../assets/images/topDeals.png'";
export const new_stles = "'../../assets/images/new_styles.png'";
export const new_styles_him = "'../../assets/images/new_styles_him.png'";
export const deals = "'../../assets/images/deals.png'";
export const best_fashion = "'../../assets/images/best_fashion.png'";
