...
import { Table, Thead, Tbody, Tr, Th, Td, Box, Button, Text, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, useDisclosure, styled, FormControl, FormLabel, Input, FormHelperText, VStack, HStack, Textarea, Select } from '@chakra-ui/react'; // Import Chakra UI table components
